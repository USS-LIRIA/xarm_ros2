...
def launch_setup(context, *args, **kwargs):
    ...
    joint_states_remapping = LaunchConfiguration(
        "joint_states_remapping", default="joint_states"
    )
    ...
    camera_adapter_xyz = LaunchConfiguration(
        "camera_adapter_xyz", default='"0 0 0.0015"'
    )
    camera_adapter_rpy = LaunchConfiguration("camera_adapter_rpy", default='"0 0 0"')
    camera_adapter_tool_xyz = LaunchConfiguration(
        "camera_adapter_tool_xyz", default='"0 0 0.0015"'
    )
    camera_adapter_tool_rpy = LaunchConfiguration(
        "camera_adapter_tool_rpy", default='"0 0 0"'
    )
